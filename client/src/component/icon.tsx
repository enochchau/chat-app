...
export const PlusIcon = ({...rest}) => <FAIcon {...rest} icon={ faPlus }/>
export const UsersIcon = ({...rest}) => <FAIcon {...rest} icon={faUsers}/>
export const ImageIcon = ({...rest}) => <FAIcon {...rest} icon={faImage}/>
